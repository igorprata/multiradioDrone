...
##################### Código auxiliar para o bluetooth BLE scanner #############################
        ...
        if event == bluez.EVT_INQUIRY_RESULT_WITH_RSSI:
            ...
            if subevent == EVT_LE_CONN_COMPLETE:
                ...
                for i in range(0, num_reports):
                    ...
                    results.append("%i" % struct.unpack("b", pkt[report_pkt_offset - 2]))
                    results.append("%i" % struct.unpack("b", pkt[report_pkt_offset - 1]))
