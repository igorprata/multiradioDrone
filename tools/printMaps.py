...
# u = [(-20.7463786,-41.2290764),(-20.7465702,-41.2290774),(-20.7465712,-41.2293447),(-20.7463795,-41.2293439)]
# dist_wf = (0.0130352714943,0.0163173436884,0.00627227441873,0.0041974967925)
# results = [-20.74646803, -41.22925354] # By MSE
# results2 = [-20.7464706536,-41.2292317118] # By LSE
# real = [-20.746450, -41.229283]  # 20°44'47.2"S 41°13'45.4"W   ou    20°44.787'S 41°13.757'W
# bluetooth = [-20.74630564, -41.22922113] # By MSE
# b = [(-20.7463768,-41.2290752),(-20.746569,-41.2290756),(-20.7465713,-41.2293429),(-20.7463788,-41.2293451)]


# Ensaio no estacionamento de 19 de Nov de 2017
u = [(-20.7463786,-41.2290764),(-20.7465702,-41.2290774),(-20.7465712,-41.2293447),(-20.7463795,-41.2293439)]
dist_wf = (0.0130352714943,0.0163173436884,0.00627227441873,0.0041974967925)
results = [-20.74646803, -41.22925354] # By MSE
results2 = [-20.7464706536,-41.2292317118] # By LSE

real = [-20.746450, -41.229283]
...
lons, lats = m(lon, lat)
#lonsb, latsb = m(lonb, latb)
# plot points as red dots
m.scatter(lons, lats, marker = 'o', color='black', zorder=5)
#m.scatter(lonsb, latsb, marker = 'o', color='green', zorder=5)
...
lons5, lats5 = m(bluetooth[1], bluetooth[0])
m.plot(lons5, lats5, marker = 'o', color='blue', zorder=5)
